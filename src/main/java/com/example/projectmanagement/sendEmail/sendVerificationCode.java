...
public class sendVerificationCode {
     ...
     */
    public static final String ACCOUNT_SID = "f139f5d9f80149d8a144c7db33c9eeea";

    /**
     * AUTH_TOKEN:开发者账号认证密匙(注册后自动生成)
     */
    public static final String AUTH_TOKEN = "48f5474de76046fb9426d43987a8bd57";
    ...
    public static String smsContent = "【西电科技】尊敬的用户，您的验证码为 ";
    ...
    public static void main(String[] args) {
        ...
        String result = sendMsgTo("18009235523");
