...
public class AlipayController {
    ...
    public String notify(HttpServletRequest request) throws AlipayApiException, UnsupportedEncodingException {
        ...
        StringBuilder notifyBuild = new StringBuilder("/****************************** alipay notify 地址******************************/\n");
...
//                log.info(resp.getFundBillList());
    ...
    @PostMapping("/refund")
    @ResponseBody
    public String refund(@RequestParam("out_trade_no")String orderNo) throws AlipayApiException {
        ...
        // 退款金额
        model.setRefundAmount("300");
        // 退款原因
        model.setRefundReason("注册押金退款。");
...
//        model.setOutRequestNo(UUID.randomUUID().toString());
    ...
    @ResponseBody
    public String refundQuery(@RequestParam("out_trade_no") String orderNo, @RequestParam() String refundOrderNo) throws AlipayApiException {
